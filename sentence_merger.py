...
MAX_TTS_DUR = 10.0   # Never merge beyond this total duration
MIN_MERGE_DUR = 2.0   # Only merge if a segment is shorter than this
MAX_GAP = 0.5         # Don't merge if there's a gap > 0.5s between segments
